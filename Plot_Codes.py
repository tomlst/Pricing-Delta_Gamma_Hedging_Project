...
# print("The Price that client needs to charge is {:.5f}".format(basemodel.clientCharge(basemodel.cVar(final_pnl))))

# plt.figure(figsize=(10,6))
# min_ylim, max_ylim = plt.ylim()
# plt.hist(final_pnl, bins = 'auto', density = True, alpha = 0.5)
# plt.axvline(np.mean(final_pnl), color='r', linestyle='dashed', linewidth=1)
# plt.text(np.mean(final_pnl)+0.01, 0.05,'Mean: {:.4f}'.format(np.mean(final_pnl)), color="red", fontsize=15)
# plt.title("Profit and Loss Distribution for Time Base Hedging")
# plt.xlabel("Profit and Loss")
# plt.ylabel("Frequency")
# # sns.kdeplot(final_pnl, linewidth=3)
# plt.savefig('pnl_TimeBase.png')
# plt.show()
...
#             money_account = - pre_delta * S0 + basemodel.putPrice(S0, 0) 
#             upper_band, lower_band = (pre_delta + semiband, pre_delta - semiband)
...
#                 change_delta = current_delta - pre_delta
#                 stock_position = pre_delta = current_delta
...
#                 upper_band, lower_band = (current_delta + semiband, current_delta - semiband)
#                 if upper_band > 0:
#                     upper_band = 0
#                 elif lower_band < -1:
#                     lower_band = -1
...
# plt.axvline(np.mean(final_pnl), color='r', linestyle='dashed', linewidth=1)
# plt.text(np.mean(final_pnl)+0.01, 0.05,'Mean: {:.4f}'.format(np.mean(final_pnl)), color="red", fontsize=15)
# plt.title("Profit and Loss Distribution for Move Base Hedging")
# plt.xlabel("Profit and Loss")
# plt.ylabel("Frequency")
# # sns.kdeplot(final_pnl, linewidth=3)
# plt.savefig('pnl_MoveBase.png')
# plt.show()
...
# plt.figure(figsize=(10,6))
# min_ylim, max_ylim = plt.ylim()
# plt.hist(final_pnl, bins = 'auto', density = True)
# plt.axvline(np.mean(final_pnl), color='y', linestyle='dashed', linewidth=1)
# plt.text(np.mean(final_pnl)+0.01, 0.05,'Mean: {:.4f}'.format(np.mean(final_pnl)), color="yellow", fontsize=15)
# plt.title("Profit and Loss Distribution for Delta-Gamma Hedging Time Base")
# plt.xlabel("Profit and Loss")
# plt.ylabel("Frequency")
# # sns.kdeplot(final_pnl, linewidth=3)
# plt.savefig('pnl_DGTimeBase.png')
# plt.show()
...
# plt.axvline(np.mean(final_pnl), color='y', linestyle='dashed', linewidth=1)
# plt.text(np.mean(final_pnl)+0.01, 0.05,'Mean: {:.4f}'.format(np.mean(final_pnl)), color="yellow", fontsize=15)
# plt.title("Profit and Loss Distribution for Delta-Gamma Hedging Move Base")
# plt.xlabel("Profit and Loss")
# plt.ylabel("Frequency")
# # sns.kdeplot(final_pnl, linewidth=3)
# plt.savefig('pnl_DGTimeBase.png')
...
for semiband in semibandlist:
    ...
    axs[figIndex].hist(final_pnl,bins=50,histtype='stepfilled', alpha=0.3)
...
for i in res_array:
    ...
    if count == 0:
        a = 1
    plt.hist(i,bins=100,histtype='stepfilled', alpha=0.3)
